...
AWS Budgets, AWS CLI, JSON policy documents
...
day, since terms differ depending on when an account was opened.
...
Every day in this week ends with a teardown step. It is not optional.
...
IN PROGRESS - started August 31, 2026. Day 1 complete.
